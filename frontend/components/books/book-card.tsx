        ...
        <div className="absolute top-3 left-3 right-3 flex items-center justify-between pointer-events-none">
          <Badge
            ...
            className={`text-xs font-semibold px-2.5 py-0.5 rounded-full shadow-xs border capitalize ${
              conditionBadgeStyles[listing.bookCondition] ||
          ...
          {listing.listingStatus === "reserved" && (
            <Badge className="bg-amber-500 text-white font-extrabold text-[11px] px-2.5 py-0.5 rounded-full shadow-md uppercase tracking-wider animate-pulse flex items-center gap-1 border-amber-600">
        ...
        <div className="mt-4 pt-3 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
          ...
          <div className="text-right">
            ...
            <div className="flex items-center justify-end gap-1 text-xs text-amber-500 font-bold mt-0.5">
              ...
              <span>
                {listing.sellerRating != null && !isNaN(Number(listing.sellerRating)) && Number(listing.sellerRating) > 0
